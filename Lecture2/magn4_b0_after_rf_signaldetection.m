%% This is a demo code for the MRI part of the course HKU DRAD6213
% To simulate the magnetization precession under B0 after the 90 RF pulse (B1) excitation (signal detection).
% Author: Dr. Jianpan Huang, Email: jianpanhuang@outlook.com, 20250220
